...
const Home = () => {
  return (
    <div className="form">
      <h1 className='text-4xl text-center font-extrabold'>Add A Note</h1>
      ...
      <h1 className='text-center mt-5 text-2xl font-bold'>Your Notes</h1>
      <Notes/>
    </div>
  )
}
